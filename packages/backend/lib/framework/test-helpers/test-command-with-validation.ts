...
export type TestCommandWithValidationInputType = z.infer<typeof TestCommandWithValidationInput>;

export const TEST_COMMAND_WITH_VALIDATION = 'TEST_COMMAND_WITH_VALIDATION';

export class TestCommandWithValidation extends Command<'myId', TestCommandWithValidationInputType> {
